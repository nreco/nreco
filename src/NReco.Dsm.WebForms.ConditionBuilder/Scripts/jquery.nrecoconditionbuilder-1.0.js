/*
* NReco Condition Builder Plugin
* nrecoQueryBuilder is a jQuery plug-in that allows composing and editing abstract query.
* @version 1.0
* @author Vitaliy Fedorchenko http://code.google.com/p/nreco/wiki/nrecoConditionBuilder
* 
...
(function($) {
	...
	$.fn.nrecoConditionBuilder = function(settings) {
		...
		function addRow($container, config, defaultState) {
			var $row = $("<div class='nrecoConditionBuilderConditionRow'><span class='rowIndex'></span></div>");
