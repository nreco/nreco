...
namespace NReco.Application.Web.Profile {
	...
	/// <summary>
	/// Generic implementation of ProfileProvider used inside NReco applications
	/// </summary>
	public class ProfileProvider : System.Web.Profile.ProfileProvider {
		...
		protected IProfileStorage Storage {
			get {
				if (ProfileStorageServiceName != null)
					return AppContext.ComponentFactory.GetComponent(ProfileStorageServiceName, typeof(IProfileStorage) ) as IProfileStorage;
				return AppContext.ComponentFactory.GetService(typeof(IProfileStorage)) as IProfileStorage;
			}
		}
