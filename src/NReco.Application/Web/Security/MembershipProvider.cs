...
namespace NReco.Application.Web.Security {
	...
	public class MembershipProvider : System.Web.Security.MembershipProvider {
		...
		protected IUserStorage Storage {
			get {
				if (UserStorageServiceName != null)
					return AppContext.ComponentFactory.GetComponent(UserStorageServiceName, typeof(IUserStorage)) as IUserStorage;
				return AppContext.ComponentFactory.GetService(typeof(IUserStorage)) as IUserStorage;
			}
		}
		...
		protected IPasswordEncrypter PasswordEncrypter {
			get {
				...
				return AppContext.ComponentFactory.GetComponent(PasswordEncrypterServiceName, typeof(IPasswordEncrypter)) as IPasswordEncrypter; 
			}
		}
